...
export default function ContractInfo() {
  ...
  return (
    <Stack direction="column" spacing="6">
      <Heading fontStyle="oblique" as="h2">Auction Contract Information</Heading>
      <form onSubmit={handleSubmit}>
        ...
        <FormControl mt={6} isReadOnly>
          ...
          <InputGroup>
            <Input
              ...
              value={reservePrice}
            />
            <InputRightAddon bg="blue.100" children="WEI" />
          </InputGroup>
          <FormHelperText>
        ...
        <FormControl mt={6} isReadOnly>
          ...
          <InputGroup>
            <Input
              ...
              value={startBlock}
            />
            <InputRightAddon bg="blue.100" children="BLOCK" />
          </InputGroup>
          <FormHelperText>
        ...
        <FormControl mt={6} isReadOnly>
          ...
          <InputGroup>
            ...
            />
            <InputRightAddon bg="blue.100" children="BLOCKS" />
          </InputGroup>
          <FormHelperText>
